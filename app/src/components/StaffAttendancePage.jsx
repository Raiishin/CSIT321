...
function StaffAttendancePage() {
  return (
    <div className='fixed grid grid-cols-3 pt-9 w-full'>
        ...
        <p className='text-[#ccd6f6] text-4xl font-bold'>Attendance Rates</p></div>
        ...
        <thead class='bg-[#dcdcdc]'>
          <tr>
            ...
            <th class='p-3 text-sm font-semibold tracking-wide text-left'>Percentage of Attendees</th>
          </tr>
        </thead>
        <tbody>
          <tr class='bg-white'>
          ...
          <tr class='bg-[#f5f5f5]'>
            ...
            <td class='p-3 text-sm font-semibold tracking-wide text-left'>CSCI317 - Database Performance Tuning</td>
          ...
          <tr class='bg-white'>
            ...
            <td class='p-3 text-sm font-semibold tracking-wide text-left'>CSCI316 Big Data Mining Techniques and Implementation</td>
          ...
          <tr class='bg-[#f5f5f5]'>
            ...
            <td class='p-3 text-sm font-semibold tracking-wide text-left'>INFO411 - Data Mining and Knowledge Discovery</td>
            <td class='p-3 text-sm font-semibold tracking-wide text-left'>324</td>
          ...
          <tr class='bg-white'>
            ...
            <td class='p-3 text-sm font-semibold tracking-wide text-left'>CSIT314 - Software Development Methodologies</td>
