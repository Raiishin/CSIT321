...
const FAQ = () => {
  return (
    <div className="p-6">
      <div>
        <h1 className="text-4xl sm:text-4xl font-bold text-cyan">FAQs</h1>
        <p className="w-3/4 text-cyan inline-block pt-4">
          ...
          Mauris in lacus vel ligula elementum congue et a justosimp. Contact us at 61234567 or
          email to sim123@simmail.com
        </p>
      </div>
    </div>
  );
